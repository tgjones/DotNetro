    ...
    : M6502CodeGenerator(output)
{
    ...
    public override void CompileSystemConsoleWriteLineString()
    {
        ...
        Output.WriteLine("");
        WriteLabel("loop");
        Output.WriteLine($"    LDA({ArgsLabel}),Y");
    ...
    {
        Output.WriteLine($"    LDA {ArgsLabel}+3 ; Is it positive?");
        Output.WriteLine($"    BPL positive");
        WriteLabel("negative");
        Output.WriteLine($"    LDA #'-' ; 2s-complement it");
        Output.WriteLine($"    JSR osasci");
        Output.WriteLine($"    CLC");
        Output.WriteLine($"    LDA {ArgsLabel}+0");
        Output.WriteLine($"    EOR #$FF");
        Output.WriteLine($"    ADC #1");
        Output.WriteLine($"    STA {ArgsLabel}+0");
        Output.WriteLine($"    LDA {ArgsLabel}+1");
        Output.WriteLine($"    EOR #$FF");
        Output.WriteLine($"    ADC #0");
        Output.WriteLine($"    STA {ArgsLabel}+1");
        Output.WriteLine($"    LDA {ArgsLabel}+2");
        Output.WriteLine($"    EOR #$FF");
        Output.WriteLine($"    ADC #0");
        Output.WriteLine($"    STA {ArgsLabel}+2");
        Output.WriteLine($"    LDA {ArgsLabel}+3");
        Output.WriteLine($"    EOR #$FF");
        Output.WriteLine($"    ADC #0");
        Output.WriteLine($"    STA {ArgsLabel}+3");
        WriteLabel("positive");
        ...
        Output.WriteLine($"    LDA {ArgsLabel}+0:SBC PrDec32Tens+0,Y:STA {ArgsLabel}+0");
        Output.WriteLine($"    LDA {ArgsLabel}+1:SBC PrDec32Tens+1,Y:STA {ArgsLabel}+1");
        Output.WriteLine($"    LDA {ArgsLabel}+2:SBC PrDec32Tens+2,Y:STA {ArgsLabel}+2");
        Output.WriteLine($"    LDA {ArgsLabel}+3:SBC PrDec32Tens+3,Y:STA {ArgsLabel}+3");
        Output.WriteLine($"    INX:BCS PrDec32Lp2");
        Output.WriteLine($"    LDA {ArgsLabel}+0:ADC PrDec32Tens+0,Y:STA {ArgsLabel}+0");
        Output.WriteLine($"    LDA {ArgsLabel}+1:ADC PrDec32Tens+1,Y:STA {ArgsLabel}+1");
        Output.WriteLine($"    LDA {ArgsLabel}+2:ADC PrDec32Tens+2,Y:STA {ArgsLabel}+2");
        Output.WriteLine($"    LDA {ArgsLabel}+3:ADC PrDec32Tens+3,Y:STA {ArgsLabel}+3");
